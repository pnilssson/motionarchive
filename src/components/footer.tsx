...
export default async function Component() {
  return (
    <section className="py-10 sm:pt-16 md:pt-24 container">
      <div className=" mb-8 rounded-xl bg-gradient-to-br from-violet-100 to-sky-100 px-8 md:px-24 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-y-16 gap-x-12">
          <div className="col-span-2 lg:pr-8">
            <h4 className="font-bold text-2xl">Motion Archive</h4>

            <p className="text-base leading-relaxed text-gray-600 mt-7">
              We aim to make it easy for you to start tracking your workouts
              today by providing a simple digital journal solutions.
            </p>
        ...
        <p className="text-sm text-center">
          © Copyright 2024, All Rights Reserved by Motion Archive
        </p>
      </div>
    </section>
  );
